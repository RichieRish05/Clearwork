...
const Navbar1 = ({ user }: Navbar1Props) => {
  ...
  return (
    <div className="flex justify-center w-full py-6 px-4">
      <div className="flex items-center justify-between px-6 py-3 bg-white rounded-full border border-black shadow-[0_4px_0_0_rgba(0,0,0,1)] w-full max-w-3xl relative z-10">
